...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        body = {
            ...
            "metes_solution": run(),
            "yusuf_solution_genetic_algorithm_all_cores": run_genetic_algorithm(multithreaded=True),
            "yusuf_solution_genetic_algorithm_single_core": run_genetic_algorithm(multithreaded=False)
