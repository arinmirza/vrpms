...
def run(N_in, M_in, k_in, q_in, W_in, duration_in, demand_in, ist_in):
    ...
    processed_list = Parallel(n_jobs=num_cores)(delayed(ga)(N_in=N, M_in=M, k_in=K, q_in=Q, W_in=DEPOT, duration_in=DIST_DATA, demand_in=LOAD, ist_in=vehicles_start_times, permutations=best) for i in inputs)
